        ...
        <div className="bg-white dark:bg-slate-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-slate-200 dark:border-slate-700">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <button type="button" onClick={() => { window.location.href = `${API_BASE}/api/auth/apple`; }} className="w-full flex justify-center items-center py-2 px-4 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-slate-200 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600 transition-colors">
              ...
              <button type="button" onClick={() => { window.location.href = `${API_BASE}/api/auth/sso`; }} className="w-full flex justify-center items-center py-2 px-4 border border-gray-300 dark:border-slate-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-slate-200 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600 transition-colors">
                Log in with Organization SSO (OIDC)
              </button>
            </div>
