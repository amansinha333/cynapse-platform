  ...
  return (
    <div className="min-h-screen bg-[#042417] text-slate-100">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#115e49]/35 via-[#042417] to-[#042417]" />
        <div className="pointer-events-none absolute -left-20 top-40 h-72 w-72 rounded-full bg-emerald-500/10 blur-[90px]" />
        <div className="relative mx-auto max-w-3xl px-6 py-20 md:py-28 text-center">
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-full border border-white/15 bg-white/5">
              <Sparkles className="h-6 w-6 text-[#facc15]" />
            </div>
            <h1 className="text-4xl font-bold tracking-tight text-white md:text-5xl">Our mission</h1>
            <p className="mt-8 text-xl leading-relaxed text-slate-200 md:text-2xl">
      ...
      <div className="mx-auto max-w-3xl space-y-8 px-6 py-16 md:py-20 text-slate-300">
