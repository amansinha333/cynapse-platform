  ...
  return (
    <div className={MARKETING_PAGE}>
      <header className={MARKETING_HEADER}>
        <div className={MARKETING_HEADER_INNER}>
          ...
          <div className="flex items-center gap-6">
            <Link
              to="/privacy"
              className="hidden text-sm font-semibold text-slate-600 hover:text-[#22c55e] sm:inline"
            >
              Privacy
            </Link>
            <Link
      ...
      <section className="relative overflow-hidden border-b border-slate-200">
        ...
        <div className="pointer-events-none absolute -right-40 top-20 h-96 w-96 rounded-full bg-emerald-400/10 blur-[100px]" />
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <m.div
            ...
            className="max-w-3xl"
          >
            <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-emerald-600">Enterprise Trust</p>
            <h1 className="text-4xl font-bold tracking-tight text-[#042f1f] md:text-5xl lg:text-6xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/dashboard"
                className="inline-flex items-center gap-2 rounded-full bg-[#22c55e] px-5 py-3 text-sm font-bold text-white shadow-lg shadow-emerald-900/25 transition-colors hover:bg-[#16a34a]"
              >
                View the platform <ArrowRight className="h-4 w-4" />
              </Link>
              <a
                href="mailto:security@cynapse.com"
                className="inline-flex items-center rounded-full border border-slate-300 px-5 py-3 text-sm font-bold text-[#042f1f] transition-colors hover:border-emerald-300 hover:bg-emerald-50"
              >
                Contact security
              </a>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        <div className="grid gap-6 md:grid-cols-2">
          {pillars.map((pillar, i) => {
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-[#22c55e]">
                <PillarIcon className="h-6 w-6" strokeWidth={1.75} />
              </div>
              <h2 className="text-xl font-bold text-[#042f1f]">{pillar.title}</h2>
      ...
      <section className="border-t border-slate-200 bg-emerald-50/40">
        <div className="mx-auto max-w-4xl space-y-16 px-6 py-20 text-slate-600">
          <article className="space-y-4">
            <div className="flex items-center gap-3">
              <Server className="h-7 w-7 text-[#22c55e]" />
              <h2 className="text-2xl font-bold text-[#042f1f]">Multi-Tenant Data Isolation</h2>
            </div>
          ...
          <article className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-[#042f1f]">Hard-Gate Compliance Governance</h2>
            </div>
            <p className="leading-relaxed">
          ...
          <article className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-[#042f1f]">Prioritization Integrity</h2>
            </div>
            <p className="leading-relaxed">
          ...
          <article className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-[#042f1f]">Encryption at Rest & In Transit</h2>
            </div>
            <p className="leading-relaxed">
            ...
            <p className="leading-relaxed">
              ...
              <a href="mailto:security@cynapse.com" className="font-semibold text-[#22c55e] hover:text-emerald-700">
      ...
      <footer className="border-t border-slate-200 py-12 text-center">
        ...
        <div className="mt-4 flex justify-center gap-6 text-sm font-semibold">
          <Link to="/privacy" className="text-[#22c55e] hover:text-emerald-700">
            Privacy Policy
          </Link>
          <Link to="/terms" className="text-[#22c55e] hover:text-emerald-700">
            Terms of Service
          </Link>
        </div>
      </footer>
