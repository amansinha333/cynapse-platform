  ...
  return (
    <div className={MARKETING_PAGE}>
      ...
      <main className="mx-auto max-w-4xl space-y-6 px-6 py-20 text-slate-600">
        <h1 className="text-3xl font-bold tracking-tight text-[#042f1f] md:text-4xl">Terms of Service</h1>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">1. The Services</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">2. Accounts and access</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">3. Acceptable use</h2>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">4. Customer data</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">5. Intellectual property</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">6. Third-party services</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">7. Confidentiality</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">8. Disclaimers</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">9. Limitation of liability</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">10. Indemnity</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">11. Term and termination</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">12. Governing law</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">13. Changes</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-bold text-[#042f1f]">14. Contact</h2>
        <p>
